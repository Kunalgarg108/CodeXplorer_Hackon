...
export default function DailyCheckinCard({ onSubmitSuccess }) {
  ...
  return (
    <div className="neo-card-glow border-signal/20 p-5 space-y-4 text-left">
      ...
      <p className="text-xs text-mist font-thin -mt-2">How are you doing today? Keep your AI advisor updated.</p>
      ...
      <div className="space-y-1">
        ...
        <select
          ...
          className="w-full bg-[#001533] border border-[#11263b] text-fog text-xs rounded-lg p-2 outline-none focus:border-signal"
        >
